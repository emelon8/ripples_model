...
int main()
{
	...
	gei = 0.1;  /*** 0.1 ***/
	gii = 0.2;
	geext = 0.01; giext = 0.06; //geext = 0.01; giext = 0.02
	...
	fopen_s(&volt1, "10000ms_voltage_1-500_voltages_0.06giext.txt", "a");
	...
	fopen_s(&volt4501, "10000ms_voltage_4501-5000_voltages_0.06giext.txt", "a");
	fopen_s(&rateei, "10000ms_rateei_0.06giext.txt", "a");
	fopen_s(&rateneurons, "10000ms_rateneurons_0.06giext.txt", "a");
	run_sim(idum);
